...
// MustParseUUID is same as ParseUUID but more panic-ey
func MustParseUUID(input string) UUID {
...
// MustRandomUUID is same as RandomUUID but more panic-ey
...
// Valid checks if the UUID is good to use. Zero value is NOT valid
